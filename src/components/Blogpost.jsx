            ...
            <div className='flex flex-col justify-center mx-auto md:flex-row md:flex-wrap md:gap-4 animate-slideup'>
                {
                    post.map((post) => {
                        return (
                            <div key={post.id} className='blog-card m-[20px] md:hover:scale-105 duration-200'>
                                <div>
                                ...
                                <div className='blog-text'>
                                    ...
                                    <p className='text-gray-300'>Lorem, ipsum dolor sit amet consectetur adipisicing
                                        ...
                                        molestias perspiciatis nemo reprehenderit nihil debitis?<Link to={`/details/${post.id}`}><span className='text-theme hover:text-white'> Read more</span></Link></p>
                                </div>
